...
const val SP_OEM_AUTOSTART_GUIDED = "sp_oem_autostart_guided"
...
const val SP_ENABLE_API_CAMERA = "enable_api_camera"
...
/** ★ Tailscale直连模式开关（true=被控端监听56786接受控制端直连，false=传统中继模式） */
